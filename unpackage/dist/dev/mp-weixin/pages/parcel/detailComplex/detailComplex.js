...
var _detailComplex = _interopRequireDefault(__webpack_require__(/*! ./pages/parcel/detailComplex/detailComplex.vue */ 287));
// @ts-ignore
...
/* harmony import */ var _detailComplex_vue_vue_type_template_id_318b1ce2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detailComplex.vue?vue&type=template&id=318b1ce2& */ 288);
/* harmony import */ var _detailComplex_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detailComplex.vue?vue&type=script&lang=js& */ 290);
  ...
  methods: {
    ...
    add: function add() {
      ...
      this.http.post('', this.message).then(function (res) {
        _this3.vusui.close("loading");
        if (res.code != 0) {
          _this3.vusui.alert(res.msg);
          return false;
        } else {
          _this3.vusui.alert('新增成功', {
            yes: function yes() {
              that.loadMessage();
